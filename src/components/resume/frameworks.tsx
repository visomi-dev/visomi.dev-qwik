...
import reactLogo from '~/media/images/resume/logos/react.svg';
import angularLogo from '~/media/images/resume/logos/angular.svg';
import vueLogo from '~/media/images/resume/logos/vue.svg';
import nestjsLogo from '~/media/images/resume/logos/nestjs.svg';
import expressLogo from '~/media/images/resume/logos/express.svg';
import koaLogo from '~/media/images/resume/logos/koa.svg';
import nextjsLogo from '~/media/images/resume/logos/nextjs.svg';
import nuxtLogo from '~/media/images/resume/logos/nuxt.svg';
