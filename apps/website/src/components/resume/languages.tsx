...
export const Languages = component$(() => {
  return (
    <div class="flex flex-col gap-3">
      <p class="text-sm text-slate-500">{$localize`Languages`}</p>
      ...
      <ul class="flex flex-col gap-3">
        <li class="flex gap-2">
          ...
          <div class="flex flex-col gap-1">
            <p class="text-slate-700">{$localize`Spanish`}</p>

            <p class="leading-4 text-slate-500">{$localize`Native`}</p>
          </div>
        </li>
        ...
        <li class="flex gap-2">
          ...
          <div class="flex flex-col gap-1">
            <p class="text-slate-700">{$localize`English`}</p>

            <p class="leading-4 text-slate-500">{$localize`B1`}</p>
          </div>
        </li>
      </ul>
    </div>
